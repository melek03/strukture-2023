...
// dodatak od 11 zadatka
int calculateHash(char);
void insertSortCountryHash(HashTable*, char, char);
Country* searchCountryInHashTable(HashTable*, char);
void printCountriesFromHash(HashTable*);
